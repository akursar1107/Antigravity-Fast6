...
Usage:
    from backend.services.player_stats_service import update_player_stats, get_player_form
...
from backend.analytics.nfl_data import load_data
import logging
...
def update_player_stats(season: int, week: Optional[int] = None) -> Dict[str, int]:
    ...
    try:
        ...
        with get_db_context() as conn:
            ...
            # Get last TD week data from backend.database
