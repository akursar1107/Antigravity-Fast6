"""
Analytics Services Package — Business logic analytics (uses database).
See services/analytics/README.md for separation from analytics/ (low-level data).

This package contains all Phase 5 analytics features:
- player_stats.py: Player performance tracking and TD analysis
- roi_trends.py: User profitability and ROI calculations
