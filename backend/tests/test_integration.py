...
from backend.config import THEME, SEASONS, TEAM_MAP, FEATURES, SCORING_FIRST_TD
...
class TestConfigurationLoading(unittest.TestCase):
    ...
    def test_config_loads_on_import(self):
        ...
        try:
            from backend.config import THEME, SEASONS, TEAM_MAP
...
class TestScoringIntegration(unittest.TestCase):
    ...
    def test_scoring_values_valid(self):
        ...
        from backend.config import SCORING_FIRST_TD, SCORING_ANY_TIME
