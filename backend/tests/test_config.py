...
class TestConfigurationReloading(unittest.TestCase):
    ...
    def test_config_stable_across_imports(self):
        ...
        from backend.config import SCORING_FIRST_TD as FIRST_TD_1
        from backend.config import SCORING_FIRST_TD as FIRST_TD_2
    ...
    def test_theme_stable_across_imports(self):
        ...
        from backend.config import THEME as THEME_1
        from backend.config import THEME as THEME_2
