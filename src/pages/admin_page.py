...
Currently handles prediction input and result checking.
Will be expanded in Phase 1 for database management (picks, results, users).
"""
...
def show_admin_interface(df: pd.DataFrame, season: int, schedule: pd.DataFrame) -> None:
    """Admin interface with prediction management."""
    # TODO: In Phase 1, add tabs for:
    # - Pick management (add/edit picks in database)
    # - Results tracking (update outcomes)
    # - User/group management
    
    show_prediction_tab(schedule, season)
